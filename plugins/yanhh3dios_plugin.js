...
function getManifest() {
    return JSON.stringify({
        ...
        "iconUrl": "https://yanhh3d.ac/storage/movies/tien-nghich-1782036350.png",
        "isEnabled": true,
        "isAdult": false,
        "type": "MOVIE",
        "layoutType": "VERTICAL"
...
function getUrlDetail(slug) {
    ...
    if (slug.indexOf("|") !== -1) {
        ...
        if (parts.length >= 3) {
            ...
            return "https://yanhh3d.ee/wp-content/themes/halimmovies/player.php?episode_slug=" + epSlug + "&server_id=" + svId + "&subsv_id=&post_id=" + postId;
        }
    }
